...
NOTE: This is a cut-down clone of the following repository:
https://github.com/linuxserver/docker-code-server.git

For all intents and purposes, this repos function is simply to enable additional features, such as aws-adfs, terraform, and a select few other functions, without using mods.
